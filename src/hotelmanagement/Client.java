...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Créer un nouveau client");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (jTextField1.getText().isEmpty()) {
                ...
                String sql = "insert into customers values(customer_id_seq.nextval,initcap(?),initcap(?),?,initcap(?),?,?,lower(?))";
                ...
                if (res == 0) {
                    JOptionPane.showMessageDialog(null, "Client non ajoutée");
                } else {
                    JOptionPane.showMessageDialog(null, "Client ajoutés avec succès");
                }
            }
