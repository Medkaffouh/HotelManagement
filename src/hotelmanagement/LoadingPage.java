...
public class LoadingPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_hotel_60px.png"))); // NOI18N
        jLabel1.setText("Atlantic");

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 0, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 102, 102));
        jLabel2.setText("Hôtel management");

        jLabel3.setText("Créé par Mohamed kaffouh");

        jLabel4.setFont(new java.awt.Font("Trebuchet MS", 1, 20)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("99%");
        jLabel4.setMaximumSize(new java.awt.Dimension(45, 45));
        jLabel4.setMinimumSize(new java.awt.Dimension(45, 45));
        jLabel4.setPreferredSize(new java.awt.Dimension(70, 45));
    ...
    public static void main(String args[]) {
        ...
        try {
            for(int i=0;i<=100;i++){
                Thread.sleep(10);
                lp.jLabel4.setText(Integer.toString(i)+"%");
