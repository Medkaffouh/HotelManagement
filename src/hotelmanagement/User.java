...
public class User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(350, 638));
        setMinimumSize(new java.awt.Dimension(350, 638));
        setPreferredSize(new java.awt.Dimension(350, 638));
        setResizable(false);
        ...
        jLabel1.setText("Créer un nouveau utilisateur");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            try {
                ...
                String qrr = "select * from users where email=lower(?)";
                pst3 = con.prepareStatement(qrr);
                ...
                if (rs3.next()) {
                    ...
                    if (jTextField7.getText().isEmpty()) {
                        ...
                        String qr2 = "insert into users(USER_ID,FIRST_NAME,LAST_NAME,PHONE_NUMBER,EMAIL,DATEOFBIRTH,"
                                + "ISADMIN,PASSWORD,QCHECK,ADMIN_ID) values(user_seq.nextval,initcap('" + fname + "'),"
                                + "initcap('" + lname + "'),'" + phone + "',lower('" + mail + "'),'" + dob + "'," + admin + ","
                                + "'" + pass2 + "',initcap'" + qcheck + "',null)";
                        st = con.createStatement();
                        int res = st.executeUpdate(qr2);
                        if (res == 0) {
                            JOptionPane.showMessageDialog(null, "Utilisateur non ajoutée");
                        } else {
                            JOptionPane.showMessageDialog(null, "Utilisateur ajoutés avec succès");
                        }
                    } else {
                        jLabel28.setText("");
